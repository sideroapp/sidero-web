...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <Container className="grid grid-cols-1 items-center gap-10 py-20 md:grid-cols-2 md:gap-12 lg:gap-16 lg:py-28">
        ...
        >
          <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-md sm:p-8">
            <Image
